-- ============================================================================
-- COMMUNICATION FEATURES MIGRATION
-- Adds SMS, voice call capabilities with rate limiting and monitoring
-- ============================================================================

-- Add new event types to contact timeline
ALTER TYPE contact_event_type ADD VALUE IF NOT EXISTS 'sms_sent';
ALTER TYPE contact_event_type ADD VALUE IF NOT EXISTS 'sms_received';
ALTER TYPE contact_event_type ADD VALUE IF NOT EXISTS 'voice_call_made';
