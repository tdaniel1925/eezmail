...
export function AIAssistantPanel(): JSX.Element {
  ...
  if (!mounted || !isVisible) {
    console.log(
      'AIAssistantPanel: Not rendering - mounted:',
      mounted,
      'isVisible:',
      isVisible
    );
  ...
  console.log(
    'AIAssistantPanel: Rendering panel - isExpanded:',
    isExpanded,
    'isDesktop:',
    isDesktop
  );
      ...
      <>
          ...
          {isExpanded && (
            <div className="flex flex-1 flex-col overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto">
                {sections.threadSummary && (
                  <ThreadSummary email={currentEmail} />
                )}

                {sections.smartContext && (
                  <SmartContextCards email={currentEmail} />
                )}
              </div>
            </div>
          )}
        ...
        {!isExpanded && (
          <button
            ...
            className="fixed bottom-6 right-6 z-30 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-white shadow-lg hover:bg-primary/90 transition-all"
            ...
            <>
              ...
              >
                ...
                <div className="flex flex-1 flex-col overflow-hidden">
                  ...
                  {/* Scrollable Content Below */}
                  <div className="flex-1 overflow-y-auto">
                    {sections.emailInsights && (
                      <EmailInsights email={currentEmail} />
                    )}
