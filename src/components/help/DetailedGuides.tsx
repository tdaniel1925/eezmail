...
export function DetailedGuides(): JSX.Element {
  ...
  const guides: Guide[] = [
      ...
      sections: [
          ...
          content: (
            <div className="space-y-4">
              <p className="text-sm text-gray-700 dark:text-white/70">
                EaseMail uses a three-tier categorization system designed to
                help you focus on what matters most while keeping everything
                organized.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-lg border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-500/10 p-4">
                  ...
                  <p className="text-sm text-gray-700 dark:text-white/70 mb-2">
                    Bulk emails, newsletters, and updates you can read when
                    convenient.
                  </p>
                  <p className="text-xs font-medium text-gray-900 dark:text-white mb-1">
                    Typically includes:
                ...
                <div className="rounded-lg border-l-4 border-gray-400 bg-gray-50 dark:bg-gray-500/10 p-4">
                  ...
                  <p className="text-sm text-gray-700 dark:text-white/70 mb-2">
                    Transactional emails organized for easy reference and
                    searching.
                  </p>
                  <p className="text-xs font-medium text-gray-900 dark:text-white mb-1">
                    Typically includes:
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                EaseMail uses AI and machine learning to automatically
                categorize incoming emails based on multiple factors:
              </p>
              ...
              <div className="rounded-lg bg-gray-50 dark:bg-white/5 p-4 space-y-2 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 dark:text-white/60">
                      {' '}
                      Is the sender in your contacts? Have you emailed them
                      before?
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 dark:text-white/60">
                      {' '}
                      AI examines the email content, subject, and structure
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 dark:text-white/60">
                      {' '}
                      System learns from your past categorization decisions
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 dark:text-white/60">
                      {' '}
                      Identifies common patterns like newsletters, receipts,
                      etc.
                    </span>
                  </div>
                </div>
              ...
              <div className="rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 p-3">
                <p className="text-sm text-blue-900 dark:text-blue-300">
                  <strong>Pro Tip:</strong> The more you use EaseMail and
                  correct categorizations, the smarter the system becomes. It
                  typically achieves 95%+ accuracy after a few days of use!
                </p>
              </div>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                You can manually move emails between categories to train the AI
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-lg bg-gray-50 dark:bg-white/5 p-3">
                  ...
                  <p className="text-xs text-gray-600 dark:text-white/60">
                    Click and drag an email to the desired category in the
                    sidebar
                  </p>
                </div>
    ...
    },
    {
      ...
      icon: Sparkles,
      description:
        'Smart email management with AI screening, summaries, and quick replies',
      sections: [
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                When someone emails you for the first time, EaseMail&apos;s AI
                Screener analyzes the email and suggests the best category.
              </p>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <div className="rounded bg-gray-50 dark:bg-white/5 p-3">
                    ...
                    <p className="text-xs text-gray-600 dark:text-white/60">
                      Choose a different category to teach the AI your
                      preference
                    </p>
                  </div>
                  <div className="rounded bg-gray-50 dark:bg-white/5 p-3">
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                ...
                summaries that capture key points and action items.
              </p>
              ...
              <div className="rounded-lg bg-blue-50 dark:bg-blue-500/10 p-4 space-y-2">
                ...
                <ul className="space-y-1 text-xs text-gray-700 dark:text-white/70">
                  <li>
                    • <strong>Key Points:</strong> Main topics and important
                    information
                  </li>
                  <li>
                    • <strong>Action Items:</strong> Tasks or responses needed
                  </li>
                  <li>
                    • <strong>Sentiment:</strong> Tone detection (urgent,
                    positive, neutral, etc.)
                  </li>
                  <li>
                    • <strong>Context:</strong> Relevant background from
                    previous emails
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-2">
                ...
                <ol className="list-decimal pl-5 space-y-1 text-xs text-gray-600 dark:text-white/60">
                  ...
                  <li>
                    Look for the AI summary at the top (appears automatically
                    for emails over 100 words)
                  </li>
                  <li>
                    Click &quot;Show Full Email&quot; to read the complete
                    message
                  </li>
                </ol>
              </div>
              ...
              <div className="rounded-lg bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/30 p-3">
                <p className="text-xs text-yellow-900 dark:text-yellow-300">
                  <strong>Tip:</strong> Summaries are especially useful for
                  newsletters and long email threads. You can enable/disable
                  them in Settings → AI Preferences.
                </p>
              </div>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                AI-generated response suggestions that match your communication
                style and context.
              </p>
              ...
              <div className="rounded-lg bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/30 p-3">
                <p className="text-xs text-indigo-900 dark:text-indigo-300">
                  <strong>Customize:</strong> Set your preferred default tone in
                  Settings → AI Preferences → Quick Reply Tone
                </p>
              </div>
            </div>
          ),
      ...
      sections: [
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                Create custom folders to organize emails beyond the main
                categories.
              </p>
              ...
              <div className="rounded-lg bg-gray-50 dark:bg-white/5 p-4">
                ...
                <ul className="space-y-1 text-xs text-gray-700 dark:text-white/70">
                  ...
                  <li>
                    • Right-click folders for options (rename, delete, etc.)
                  </li>
              ...
              <div className="rounded-lg bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/30 p-3">
                <p className="text-xs text-green-900 dark:text-green-300">
                  <strong>Best Practice:</strong> Keep your folder structure
                  simple. 5-10 main folders with occasional sub-folders works
                  best for most users.
                </p>
              </div>
            </div>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                Labels allow you to tag emails with multiple categories without
                moving them from their folder.
              </p>
              ...
              <div className="rounded-lg bg-gray-50 dark:bg-white/5 p-3">
                <p className="text-xs text-gray-700 dark:text-white/70">
                  <strong>Example use cases:</strong> Label emails as
                  &quot;Urgent&quot;, &quot;Follow-up&quot;, &quot;Waiting for
                  response&quot;, or create project-specific labels like
                  &quot;Q4 Launch&quot;
                </p>
              </div>
            </div>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="text-xs">
                    ...
                    <p className="text-gray-600 dark:text-white/60 ml-4">
                      When emails arrive from, to, or containing specific
                      criteria
                    </p>
                  </div>
                  <div className="text-xs">
                    ...
                    <p className="text-gray-600 dark:text-white/60 ml-4">
                      Optional: Check for subject keywords, sender domain,
                      attachments, etc.
                    </p>
                  </div>
                  <div className="text-xs">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded bg-gray-50 dark:bg-white/5 p-3 text-xs">
                    ...
                    <div className="text-gray-600 dark:text-white/60">
                      If from @importantclient.com → Star + Label
                      &quot;VIP&quot;
                    </div>
                  </div>
                  <div className="rounded bg-gray-50 dark:bg-white/5 p-3 text-xs">
                    ...
                    <div className="text-gray-600 dark:text-white/60">
                      If subject contains &quot;receipt&quot; or
                      &quot;invoice&quot; → Move to Paper Trail
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/30 p-3">
                <p className="text-xs text-yellow-900 dark:text-yellow-300">
                  <strong>Pro Tip:</strong> Test rules with &quot;Apply to
                  existing emails&quot; to see how they work before enabling
                  them permanently.
                </p>
              </div>
            </div>
      ...
      sections: [
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                Use the search bar at the top to find emails by content, sender,
                subject, or date.
              </p>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 p-3">
                <p className="text-xs text-blue-900 dark:text-blue-300">
                  <strong>Combine operators:</strong> Use multiple operators
                  together, like{' '}
                  <code className="bg-blue-200 dark:bg-blue-700 px-1 rounded">
                    from:boss@company.com has:attachment after:2024-01-01
                  </code>
                </p>
              </div>
            </div>
      ...
      sections: [
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                Add a personal touch by recording voice messages to include in
                your emails.
              </p>
              ...
              <div className="rounded-lg bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/30 p-3">
                <p className="text-xs text-yellow-900 dark:text-yellow-300">
                  <strong>Browser Support:</strong> Voice messages work best in
                  Chrome, Edge, and Safari. Firefox may have limited support.
                </p>
              </div>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="space-y-3">
              <p className="text-sm text-gray-700 dark:text-white/70">
                When you receive an email with a voice message, you&apos;ll see
                a playback control in the email.
              </p>
              ...
              <div className="rounded-lg bg-blue-50 dark:bg-blue-500/10 p-4 space-y-2">
                ...
                <ul className="list-disc pl-5 space-y-1 text-xs text-gray-600 dark:text-white/60">
                  <li>
                    <strong>Play/Pause:</strong> Click to start or pause
                    playback
                  </li>
                  <li>
                    <strong>Seek:</strong> Drag the progress bar to jump to any
                    point
                  </li>
                  <li>
                    <strong>Speed:</strong> Adjust playback speed (0.5x to 2x)
                  </li>
                  <li>
                    <strong>Download:</strong> Save the audio file to your
                    device
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="rounded bg-gray-50 dark:bg-white/5 p-2">
                    <kbd className="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded mr-1">
                      Space
                    </kbd>
                    <span className="text-gray-600 dark:text-white/60">
                      Play/Pause
