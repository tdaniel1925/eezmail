...
// Validation schema for draft emails request
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Validate parameters
    const validatedData = draftEmailSchema.parse({ limit, offset });

    console.log(`📧 Fetching draft emails for user:`, user.id);
    ...
    console.log(`📧 Found draft emails:`, draftEmails.length);
