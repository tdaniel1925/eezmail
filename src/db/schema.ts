...
// Account Type Enum (updated for hierarchical system)
...
export const userRoleHierarchyEnum = pgEnum('user_role_hierarchy', [
  'user',
  'team_user',
  'team_admin',
  'team_super_admin',
...
export const users = pgTable('users', {
  ...
  // NEW: Hierarchical role system
  roleHierarchy: userRoleHierarchyEnum('role_hierarchy').default('user'),

  sandboxCompanyId: uuid('sandbox_company_id'),

  // NEW: Sandbox user flags
  isSandboxUser: boolean('is_sandbox_user').default(false),
  sandboxAutoGeneratedPassword: boolean(
    'sandbox_auto_generated_password'
  ).default(false),
...
export const permissions = pgTable('permissions', {
  id: uuid('id').primaryKey().defaultRandom(),
  code: text('code').notNull().unique(), // e.g., 'can_view_users', 'can_manage_billing'
  name: text('name').notNull(),
  description: text('description'),
  category: text('category'), // e.g., 'users', 'billing', 'settings', 'admin'
...
export const rolePermissions = pgTable(
  ...
  {
    id: uuid('id').primaryKey().defaultRandom(),
    role: userRoleHierarchyEnum('role').notNull(),
...
export const userPermissionOverrides = pgTable(
  ...
  (table) => ({
    userPermissionIdx: uniqueIndex('user_permission_idx').on(
      table.userId,
      table.permissionId
    ),
  })
...
export const onboardingProgress = pgTable('onboarding_progress', {
  ...
  onboardingStep: text('onboarding_step').default('account_connection'),
  foldersConfigured: boolean('folders_configured').default(false).notNull(),
...
// Type exports for permissions system
